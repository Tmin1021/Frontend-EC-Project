        ...
        <div className='w-full h-[120px] bg-amber-400 flex'>
            ...
            <div className='flex flex-col justify-between pl-2'>
                ...
                <div className='flex items-center gap-4'>
                    <p className='text-red-500 font-semibold text-lg'>{product_cart.quantity * (product.product_id.substring(0,1)==='B'? product.options[product_cart.option].price : product.price)}</p>
