...
function Product_Banner() {
  ...
  return (
    <div className='cursor-pointer flex gap-2 p-2 items-center bg-purple-600/80 rounded-lg w-full shadow-gray-300 shadow-sm hover:rounded-xl hover:bg-purple-600 hover:shadow-lg hover:px-8 transition-all'>
