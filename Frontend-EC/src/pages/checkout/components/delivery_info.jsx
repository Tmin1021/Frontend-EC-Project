...
const [message, setMessage] = useState('')
  ...
  return (
    <div className='flex flex-col gap-2 bg-white px-2 md:px-4 py-4 shadow-sm border-1 border-gray-100 rounded-lg overflow-auto'>
        ...
        <Text_Item name='Delivery Address' content={user.address} placeholder='255 Nguyen Van Cu, District 5'/>
        <Text_Item name='Other Message (optional)' content={message} placeholder='e.g. Place the package in front of the building ' rows={3}/>
